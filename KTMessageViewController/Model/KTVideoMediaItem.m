...
@interface KTVideoMediaItem ()

@property (strong, nonatomic) NSImageView *cachedVideoImageView;

@end


@implementation KTVideoMediaItem
...
- (NSView *)mediaView
{
    ...
    if (self.cachedVideoImageView == nil) {
        ...
        NSImage *playIcon = [[NSImage kt_defaultPlayImage] kt_imageMaskedWithColor:[NSColor lightGrayColor]];
...
//        imageView.clipsToBounds = YES;
        ...
        NSImageView *imageView = [NSImageView imageViewWithImage:playIcon];
        imageView.image.backgroundColor = [NSColor blackColor];
        imageView.frame = CGRectMake(0.0f, 0.0f, size.width, size.height);
        //imageView.contentMode = UIViewContentModeCenter;
        //imageView.clipsToBounds = YES;
...
- (BOOL)isEqual:(id)object
{
    ...
    KTVideoMediaItem *videoItem = (KTVideoMediaItem *)object;
...
{
    KTVideoMediaItem *copy = [[[self class] allocWithZone:zone] initWithFileURL:self.fileURL
