...
/**
 *  The `KTMessagesViewController` class is an abstract class that represents a view controller whose content consists of
 *  a `KTMessagesCollectionView` is specialized to display a messaging interface.
 *
 *  @warning This class is intended to be subclassed. You should not use it directly.
 */
@interface KTMessagesViewController : NSViewController <KTMessagesCollectionViewDataSource, KTMessagesCollectionViewDelegateFlowLayout, NSTextViewDelegate>

/**
 *  Returns the collection view object managed by this view controller.
 *  This view controller is the collection view's data source and delegate.
 */
@property (weak, nonatomic, readonly) KTMessagesCollectionView *collectionView;
 ...
 *  The default value is the string returned by `[KTMessagesCollectionViewCellOutgoing cellReuseIdentifier]`.
 ...
 *  The default value is the string returned by `[KTMessagesCollectionViewCellOutgoing mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see KTMessagesCollectionViewCellOutgoing.
 *
 ...
 *  The default value is the string returned by `[KTMessagesCollectionViewCellIncoming cellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 ...
 *  The default value is the string returned by `[KTMessagesCollectionViewCellIncoming mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see KTMessagesCollectionViewCellIncoming.
 *
...
/**
 *  Returns the `UINib` object initialized for a `KTMessagesViewController`.
 *
...
/**
 *  Creates and returns a new `KTMessagesViewController` object.
 *
 *  @discussion This is the designated initializer for programmatic instantiation.
 *
 *  @return An initialized `KTMessagesViewController` object if successful, `nil` otherwise.
 */
