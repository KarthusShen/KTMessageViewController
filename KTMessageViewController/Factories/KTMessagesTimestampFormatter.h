//
//  KTMessagesTimestampFormatter.h
...
/**
 *  An instance of `KTMessagesTimestampFormatter` is a singleton object that provides an efficient means
 *  for creating attributed and non-attributed string representations of `NSDate` objects.
 *  It is intended to be used as the method by which you display timestamps in a `KTMessagesCollectionView`.
 */
@interface KTMessagesTimestampFormatter : NSObject

/**
 *  Returns the cached date formatter object used by the `KTMessagesTimestampFormatter` shared instance.
 */
